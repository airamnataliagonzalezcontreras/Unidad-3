...
# ---------------------------------------
# ESTILO PARA BOTONES ROSAS
# ---------------------------------------
def configurar_estilo_botones():
    estilo = ttk.Style()
    ...
    # Para que el color se mantenga al pasar el mouse
    estilo.map(
        "Pink.TButton",
        background=[("active", "#ff3385")]
    )
...
def mostrar_ticket(producto, precio, cantidad, total):
    ...
    btn_cerrar = ttk.Button(ticket, text="Cerrar", style="Pink.TButton", command=ticket.destroy)
...
def abrir_registro_productos():
    ...
    btn_guardar = ttk.Button(reg, text="Guardar Producto", style="Pink.TButton", command=guardar_producto)
...
def abrir_registro_ventas():
    ...
    btn_guardar = ttk.Button(ven, text="Registrar Venta", style="Pink.TButton", command=registrar_venta)
...
# Estilos de botones rosa
configurar_estilo_botones()
...
# BOTONES PRINCIPALES
btn_reg_prod = ttk.Button(ventana, text="Registro de Productos", style="Pink.TButton", command=abrir_registro_productos)
btn_reg_prod.pack(pady=10)

btn_reg_ventas = ttk.Button(ventana, text="Registro de Ventas", style="Pink.TButton", command=abrir_registro_ventas)
btn_reg_ventas.pack(pady=10)

btn_reportes = ttk.Button(ventana, text="Reportes", style="Pink.TButton", command=abrir_reportes)
btn_reportes.pack(pady=10)

btn_acerca = ttk.Button(ventana, text="Acerca de", style="Pink.TButton", command=abrir_acerca_de)
